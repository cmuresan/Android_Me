...
public class BodyPartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (listOfIds != null) {
            imageView.setImageResource(listOfIds.get(indexOfImage));
        } else {
            Log.d(TAG, "This fragment's list of ids is null");
        }
    ...
    public void setListOfIds(List<Integer> ids) {
        listOfIds = new ArrayList<>(ids);
    }

    public void setIndexOfImage(int index) {
        indexOfImage = index;
    }
}
